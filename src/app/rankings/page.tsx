...
export default function RankingsPage() {
  return (
    <div className="space-y-8">
      ...
      <section id="team-rankings" className="mt-12">
...
interface RankingItem {
  rank: number;
  name: string;
  team?: string; // Optional for team rankings where name is the team
  points: number;
}
...
function RankingCard({ title, data, isTeamRanking = false, icon }: RankingCardProps) {
  return (
