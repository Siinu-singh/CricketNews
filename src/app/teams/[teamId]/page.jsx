...
// import type { Team, Player } from "@/types"; // Type import removed
...
export default function TeamDetailPage({ params }) { // Type annotation removed
        ...
        <CardContent>
          {playersToList.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {playersToList.map((player) => ( // Player type implicitly any
